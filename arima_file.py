...
def find_order_d(df):
    ...
    plot_acf(df, ax=axes[0, 1], auto_ylims=True, lags=200)
    ...
    plot_acf(df.diff().dropna(), ax=axes[1, 1], auto_ylims=True, lags=200)
    ...
    plot_acf(df.diff().diff().dropna(), ax=axes[2, 1], auto_ylims=True, lags=200)
    ...
    plot_acf(df.diff().diff().diff().dropna(), ax=axes[3, 1], auto_ylims=True, lags=200)
    ...
    plot_acf(df.diff().diff().diff().diff().dropna(), ax=axes[4, 1], auto_ylims=True, lags=200)
    ...
    plot_acf(df.diff().diff().diff().diff().diff().dropna(), ax=axes[5, 1], auto_ylims=True, lags=200)

...
with st.sidebar:
    choose = option_menu("FinCast", ["Home","ARIMA Forecast", "LSTM Forecast", "Order Book Forecast", "Contact"],
                         icons=['house', 'bar-chart-line-fill', 'bar-chart-line','bar-chart-line-fill','person lines fill'],
